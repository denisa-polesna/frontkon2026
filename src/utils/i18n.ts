...
export const translations = {
  en: {
    ...
    postMortemTextL1: '“Fine, {name}! Maybe modern CSS IS better than 14 hardcoded negative margins. Senior engineer job security: 100%.”',
    postMortemTextL1Grid: '“Fine, {name}! Maybe CSS Grid IS better than 14 hardcoded negative margins. Senior engineer job security: 100%.”',
    postMortemTextL1Flex: '“Fine, {name}! Maybe Flexbox IS better than 14 hardcoded negative margins. Senior engineer job security: 100%.”',
  ...
  cz: {
    ...
    postMortemHeader: '🤖 DevBot-3000 Post-Mortem:',
    postMortemTextL1: '„No dobře, {name}! Možná je moderní CSS lepší než 14 natvrdo zapsaných záporných marginů. Jistota práce senior inženýra: 100 %.“',
    postMortemTextL1Grid: '„No dobře, {name}! Možná je CSS Grid lepší než 14 natvrdo zapsaných záporných marginů. Jistota práce senior inženýra: 100 %.“',
    postMortemTextL1Flex: '„No dobře, {name}! Možná je Flexbox lepší než 14 natvrdo zapsaných záporných marginů. Jistota práce senior inženýra: 100 %.“',
