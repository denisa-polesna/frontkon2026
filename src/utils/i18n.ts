...
export const translations = {
  en: {
    ...
    jiraKeyL5: 'OUT-407',
    jiraSummaryL5: '[PROD HOTFIX] "Sign Deal" button scrolls off-screen; $450k ARR deal blocked',
    jiraDescL5: 'DevBot tried to fix button visibility by giving it z-index: 2147483647 at top: 4800px. When sales reps scroll the deal activity timeline, the button vanishes into the void.',
    jiraAcL5: 'Action bar must stay docked to the bottom (position: sticky; bottom: 0;) while scrolling the timeline container.',
    ...
    l5Title: 'The Stacking Context War',
    l5Desc: 'DevBot set top: 4800px and z-index: 2147483647. Dock the action bar cleanly to the bottom of the scroll view with sticky positioning!',
    ...
    taskOverlayTitleL5: 'Task 5: Dock Sticky Action Bar',
    taskOverlayDescL5: 'Dock the action bar to the bottom of the container so it stays pinned at the bottom while scrolling.',
    ...
    editorTaskCommentL5: '/* Task: Dock action bar to bottom while scrolling */',
    ...
    // DevBot L5 (Sticky) Dialogue
    devbotL5StickyInitial: 'My z-index is higher than Outreach’s ARR! You cannot defeat a 32-bit integer, {name}!',
    devbotL5StickyFixed: 'Fixed?! Now the button is escaping the card entirely, {name}! Classic senior dev fail!',
    devbotL5StickyNoBottom: 'You typed one property and expected a miracle, {name}?! The button is still lost in the abyss! My 4800px offset reigns supreme!',
    devbotL5StickyDefeated: 'Position sticky?! The button actually docks to the viewport without a 400-line scroll listener in JavaScript, {name}?! Inconceivable!',
    ...
    victoryTitleL5: 'PR #407 REJECTED & FIXED! 🎉',
    ...
    postMortemTextL5: '“Fine! Position sticky docked the bar without a JavaScript scroll listener. You won this challenge, {name}.”',
  ...
  cz: {
    ...
    jiraKeyL5: 'OUT-407',
    jiraSummaryL5: '[PROD HOTFIX] Tlačítko podpisu odscrollovává pryč; blokován deal za $450k ARR',
    jiraDescL5: 'DevBot se pokusil zajistit viditelnost tlačítka nastavením z-indexu 2147483647 na top: 4800px. Když obchodníci scrollují časovou osou, tlačítko zmizí v propadlišti dějin.',
    jiraAcL5: 'Spodní lišta musí zůstat ukotvená dole (position: sticky; bottom: 0;) při scrollování v kontejneru.',
    ...
    l5Title: 'Válka stohovacího kontextu',
    l5Desc: 'DevBot nastavil top: 4800px a z-index: 2147483647. Ukotvi spodní lištu pomocí position: sticky!',
    ...
    taskOverlayTitleL5: 'Úkol 5: Ukotvit sticky lištu',
    taskOverlayDescL5: 'Ukotvi lištu s tlačítkem na spodní hranu kontejneru tak, aby zůstala přišpendlená na spodu i při skrolování.',
    ...
    editorTaskCommentL5: '/* Úkol: Ukotvi lištu na spodní hranu při skrolování */',
    ...
    // DevBot L5 (Sticky) Dialogue
    devbotL5StickyInitial: 'Můj z-index je vyšší než celoroční obrat Outreach! 32-bitové číslo v životě nepřekonáš, {name}!',
    devbotL5StickyFixed: 'Fixed?! To tlačítko teď uteklo z karty, {name}! Typický senior dev fail!',
    devbotL5StickyNoBottom: 'Napsal jsi jednu vlastnost a čekáš zázrak, {name}?! To tlačítko je pořád ztracené v propadlišti! Můj offset se ti směje do očí!',
    devbotL5StickyDefeated: 'Position sticky?! To tlačítko se ukotvilo bez 400 řádků scroll listeneru v JavaScriptu, {name}?! Nemožné!',
    ...
    victoryTitleL5: 'PR #407 ZAMÍTNUTO A OPRAVENO! 🎉',
    ...
    postMortemTextL5: '„No dobře! Position sticky ukotvilo lištu bez JavaScriptového scroll listeneru. Tuhle výzvu jsi vyhrál ty, {name}.“',
