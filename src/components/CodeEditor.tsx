...
export const CodeEditor: React.FC<CodeEditorProps> = ({
    ...
    >
      ...
      >
        ...
        <Typography variant="caption" sx={{ color: '#8892B0', fontSize: '0.74rem' }}>
          {t.branchLabel} <code style={{ color: '#C4B5FD' }}>devbot/neural-margins</code> &bull; Target: <code>main</code>
        </Typography>
      </Box>
  ...
  margin-top: -340px;
  margin-left: -520px;
  transform: rotate(0.001deg); /* anti-aliasing magic */
}`}
        </Box>
      </Box>
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <CodeIcon sx={{ fontSize: 16, color: '#6E3FF3' }} />
        ...
        >
          ...
          >
            <span style={{ color: '#C4B5FD', fontWeight: 700 }}>.modal-viewport</span> &#123;
          </Typography>
